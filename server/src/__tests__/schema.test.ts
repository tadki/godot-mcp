...
// SEE-1285 e2e TEMPORARY red-CI probe — reverted by the next commit immediately
describe('SEE-1285 e2e red probe (temporary)', () => {
  it('temporary probe that fails by design (see1285 e2e)', () => {
