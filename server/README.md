...
21 tools, 86 actions. Full API docs in the [Tools Reference](https://github.com/satelliteoflove/godot-mcp/blob/main/docs/tools/README.md). Highlights:
...
Tools split along the read/write boundary: every `godot_*_read` tool can be auto-allowed in your client's permission settings while writes stay gated. See the upstream docs under [docs/](https://github.com/satelliteoflove/godot-mcp/blob/main/docs/README.md) for the full picture (installation, architecture, runtime-state guide, troubleshooting).
...
**CI gates & test-timing plan** (6 PR-gate jobs incl. the mutation gate at break=100, nightly buckets, 15m budget, 100% target route, mutation-exemption ledger): see [docs/ci-test-plan.md](https://github.com/satelliteoflove/godot-mcp/blob/main/docs/ci-test-plan.md) and [docs/mutation-exemptions.md](https://github.com/satelliteoflove/godot-mcp/blob/main/docs/mutation-exemptions.md) (SEE-1334 SPEC-064).
...
- [Installation Guide](https://github.com/satelliteoflove/godot-mcp/blob/main/INSTALL.md) — MCP client configs (Claude Desktop, Claude Code, VSCode/Copilot, and more)
