...
if (fastEntries.length !== 66) {
  throw new Error(`fast tier expects 66 entries, resolved ${fastEntries.length} — an entry was renamed/retired; update the list in sync with the SEE-1291 graduation flow`);
}
